...
func (b *Balancer) EvictGuaranteedPods() error {
	...
	pods = FilterPods(pods, IsGuaranteedPod)
...
func FilterPods(pods []*corev1.Pod, judge func(*corev1.Pod) bool) []*corev1.Pod {
...
func IsGuaranteedPod(pod *corev1.Pod) bool {
	return qos.GetPodQOS(pod) == corev1.PodQOSGuaranteed
}
